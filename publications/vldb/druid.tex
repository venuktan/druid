...
core engine of the Metamarkets interactive data analysis platform. In this paper, we detail Druid's architecture, and describe how it supports real-time data ingestion, querying, and analytics. 
\end{abstract}
...
containing advertising data is shown in Table~\ref{tab:sample_data}. We will refer to this table in our examples
in later sections.
...
Recall Druid has the notion of historical and real-time segments. The Druid cluster is architected to reflect this
