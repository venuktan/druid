...
for large-scale transactional data aggregation and arbitrarily deep data exploration. Druid is very configurable
...
hour. Depending on the data volume, sharding only on the time
...
interval with the updated data. This new segment will have an increased version identifier. Multiple segments for the same data source and time range
...
\begin{figure}
\centering
\includegraphics[width = 2.5in]{cluster_scan_rate}
...
\begin{figure}
\centering
\includegraphics[width = 2.5in]{core_scan_rate}
