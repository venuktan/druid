...
Queries 4-6 are for top 100 queries on our high-cardinality dimension
and we see decreased performance with them.  Generally, top K queries
are much slower than simple aggregation queries given the increased
complexity in calcuating results.
